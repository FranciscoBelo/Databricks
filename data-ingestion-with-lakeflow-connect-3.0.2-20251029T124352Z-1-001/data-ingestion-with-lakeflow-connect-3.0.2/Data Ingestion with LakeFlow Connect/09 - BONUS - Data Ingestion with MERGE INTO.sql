...
-- DBTITLE 1,View the main users table
SELECT * 
...
-- DBTITLE 1,View the current version of the table
SELECT *
FROM main_users_target
ORDER BY ID;
...
-- DBTITLE 1,View the new data to merge into the main table
SELECT *
...
-- DBTITLE 1,Try to merge a table with an additional column (ERROR)
--------------------------------------------
...
-- DBTITLE 1,Use MERGE INTO with schema evolution
